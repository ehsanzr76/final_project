<div class="page-sidebar">
  ...
  <div class="sidebar custom-scrollbar">
    ...
    <ul class="sidebar-menu">
      ...
      <li><a class="sidebar-header" href="#"><i data-feather="layers"></i><span>دسته بندی ها</span><i
            class="fa fa-angle-right pull-right"></i></a>
        <ul class="sidebar-submenu">
          <li><a href="{{route('categories')}}"><i class="fa fa-circle"></i>مشاهده</a></li>
          <li><a href="{{route('categories.create')}}"><i class="fa fa-circle"></i>ایجاد</a></li>
        </ul>
      </li>
