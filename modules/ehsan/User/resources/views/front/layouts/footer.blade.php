<footer class="footer_area shop_footer">
                ...
                <div class="col-md-3 col-xs-6">
                    <aside class="f_widget shop_f_about">
                        ...
                        <div class="footer_info">
                            <h4><i class="fa fa-map-marker"></i>نشانی پستی:</h4>
                            <p>ایران، تهران، تهران بزرگ، کنار برج میلاد</p>
                            <h4><i class="fa fa-phone"></i>شماره تماس:</h4>
                            <a href="#"><p>09123456789</p></a>
                        </div>
                    </aside>
                </div>
                <div class="col-md-3 col-xs-6">
                    <aside class="f_widget s_product_widget">
                        <div class="s_f_title">
                            <h2>برترین <span>محصولات</span></h2>
                        </div>
                        <div class="s_p_list">
                            <div class="media">
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <a href="#"><h4>لورم ایپسوم متنی ساختگی</h4></a>
                                    <h5><del>300.000 تومان</del>200.000 تومان</h5>
                                    <ul>
                                        <li><a href="#"><i class="fa fa-star"></i></a></li>
                                        <li><a href="#"><i class="fa fa-star"></i></a></li>
                                        <li><a href="#"><i class="fa fa-star"></i></a></li>
    ...
    <div class="footer_bottom">
        <div class="container">
            <h4 class="f-text">© <script>document.write(new Date().getFullYear());</script> |  تمامی حقوق برای محفوظ است و هرگونه کپی برداری پیگرد قانونی دارد.</h4>
        </div>
    </div>
</footer>
<!--================End ag Footer Area =================-->
